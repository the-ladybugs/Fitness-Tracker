/*function new_excercise() {
  ...
  Http.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      ...
      document.getElementById("carousel-inner").innerHTML += image;
      document.getElementById("carousel-inner").innerHTML += part1;
    }
  };
}
*/
